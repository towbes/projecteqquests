sub EVENT_SAY { 
if($text=~/Hail/i){
quest::say("TESTTTTTA warm hello to you. $name! Please make yourself at home here in the serene locale of Sunset Home. Here you can forget about the [queue]. and enjoy the company of your fellow guides!");
}
